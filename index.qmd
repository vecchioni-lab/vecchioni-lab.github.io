...
[Explore this research →](research/mmDNA/index.qmd){.panel-link}
...
## (A)Biomorphogenesis
 ...
 We further develop shape-encoded architectures, in which we harness the entropic nature of self-assembly to drive complex organization of DNA components at long range. In
...
Our work began as a summer internship at NASA when Simon proposed an *E. coli* radio <a href="https://2013.igem.org/Team:Stanford-Brown/Projects/BioWires"> (2013 Stanford-Brown iGEM)</a>. Since then, we have collaborated actively with NASA, who have been deeply embedded in the work, and we now explore DNA as a viable space technology. We further explore the role that metalated nucleic acids played in the development of early life on Earth, and ultimately enabling human space exploration.
...
<p class="panel-caption">
Review of realspace and reciprocal space topology was written to unify concepts in disparate fields to spark dialogue and explore DNA as a materials design language in both spaces.
